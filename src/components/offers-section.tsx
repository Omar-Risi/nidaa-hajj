...
export default function OffersSection() {
  ...
  const hajjOffer: OfferCard = {
    ...
    duration: "10 أيام (21 مايو - 31 مايو 2026)",
    ...
    features: [
      ...
      "ليلتان في فندق خمس نجوم قريب من الحرم النبوي",
      "الإقامة في فندق ساعة مكة فيرمونت (برج الساعة)",
      "الإقامة في أبراج كدانة الفندقية في منى",
      "التنقل بقطار الحرمين السريع",
      "بوفيهات فاخرة للثلاث وجبات",
          ...
          >
              ...
              <div className="p-6">
                ...
                <div className="space-y-2 mb-4 text-sm text-gray-700">
                  <div className="flex items-start gap-2">
                    ...
                    <span>{hajjOffer.duration}</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-gold-start">•</span>
                    <span>{hajjOffer.accommodation}</span>
                  </div>
                </div>
            ...
            >
              ...
              >
                ...
                <span className="text-gold-start text-lg font-semibold"> شاهد تنفيذ حملة النداء لسكن الحجاج في منى وعرفة لموسم 1446هـ</span>
              </motion.div>
